...
const Step3 = () => {
  ...
  const initialData = {
    access_type: formData?.pickup_address?.access_type || [],
    is_stair: formData?.pickup_address?.is_stair || false,
    flights: formData?.pickup_address?.flights || 1,
    truck_distance: formData?.pickup_address?.truck_distance || "",
  };
            ...
            <div className="flex flex-col gap-4">
              <div className="my-5">
                <div className="mb-5">
                  ...
                  {formData && formData?.pickup_address?.address && (
                ...
                <div className="flex flex-wrap justify-center gap-5">
                  {appData && appData?.accessOptions?.map((option) => (
                ...
                {errors.access_type && (
                  <p className="text-red-500 text-sm text-center">{errors.access_type}</p>
                )}
              </div>
              ...
              <div className="my-5">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {appData && appData?.truckDoorDistanceOptions?.map((option, index) => (
                    <SelectableButton
                      key={index}
                      label={option}
